    ...
    <script>
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/admin/captcha?time=" + new Date().getTime());
            });
        });
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <span style="color: #ac2925" id="errorMessage"></span>
                            <span id="msgDiv"></span>
                            <div class="form-group">
                                <label class="sr-only" for="form-username">Username</label>
                                <input type="text" name="adminNickname" placeholder="请输入用户名..."
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px; display: inline-block;" class="captchaImage"
                                     src="${pageContext.request.contextPath}/admin/captcha">
